...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        text.setFont(new Font("COMIC SANS MS", Font.BOLD, 16));
        f.add(text);
        
        JButton send = new JButton("Send");
        send.setBounds(320, 655, 123, 40);
        send.setBackground(new Color(0, 0, 139));
    ...
    public static JPanel formatLabel(String out) {
        ...
        output.setFont(new Font("COMIC SANS MS", Font.BOLD, 16));
        output.setBackground(new Color(96,96,96));
